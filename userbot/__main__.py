...
@THANOSPRO.tgbot.on(events.NewMessage(pattern="/starts", func=lambda x: x.is_group))
...
@THANOSPRO.tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"start")))
